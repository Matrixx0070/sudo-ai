...
// these change and minting breaks (403). Re-capture via scripts/grok-web/statsig_capture.mjs
// if the live gate starts returning 403 with an otherwise-correct token. Selected by seed[5] % 4.
const R_GSWH7_PATHS = [
