...
try {
  ...
  const contact = crm.addContact({ name: 'the owner', email: 'owner@test.com', tags: ['owner'], notes: 'Project founder' });
  ...
  if (contact.name === 'the owner' && history.length > 0 && stats.totalContacts > 0) {
