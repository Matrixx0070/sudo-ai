...
// F97: the 'Brain providers — getModel / getEnvKeyForProvider' suite is retired
// with src/llm/legacy/providers.ts — env-key resolution now lives in
// src/llm/client.ts getProviderApiKey and route resolution in transport.ts
// (covered by tests/llm/).
