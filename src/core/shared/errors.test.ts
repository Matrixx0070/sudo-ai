/**
 * @file errors.test.ts
 * @description Tests for the custom error hierarchy and categorizeError utility.
 *
 * Coverage:
 * - SudoError base class (message, code, details, prototype chain)
 ...
 * - categorizeError: every HTTP status branch + edge cases
 */
