...
export async function createRelease(
  ...
  // Audit item 3 note: this upload is deliberately NOT run through
  // screenOpsUpload — it is a byte-exact copy of the already-uploaded,
  // HMAC-signed manifest (redaction would break the signature, and its
  // sha256 hex entries would false-positive hex_secret_64). The manifest
  // content is machine-generated by prepareBlobs, which now re-classifies
  // zones at the egress point (audit item 6).
